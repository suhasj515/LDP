...
import GridLayoutBooks from './GridLayoutBooks';

export default {
    title: 'Organism/GridLayoutBooks',
    component: GridLayoutBooks,
    argTypes: {
      backgroundColor: { control: 'color' },
    },
  };

  export const GridLayoutBooks1 = ()=>{
    const BookObj2 = {
        bookList: [
            {
                component:"img",
      ...
      return(<GridLayoutBooks BookObj={BookObj2} status="Reading"/>
      )
  }
